...
function showCustomerDetails(customerNumber)
{
    ...
    $.get(
        ...
        {action: 'get-customer-details', customerNumber: customerNumber}, // Données transmises dans la requête
        onAjaxGetCustomerDetails // fonction de callback qui sera appelée automatiquement lors de la réception de la réponse
    );
}